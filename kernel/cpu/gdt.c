...
{
    gdt_entries[id].base1 = base & 0xFFFF;
    gdt_entries[id].base2 = (base >> 16) & 0xFF;
    gdt_entries[id].base3 = (base >> 24) & 0xFF;
...
void gdt_setup()
{
    gdt_ptr.size = sizeof(struct gdt_entry_struct) * 7 - 1;
    gdt_ptr.offset = (u64)&gdt_entries;
